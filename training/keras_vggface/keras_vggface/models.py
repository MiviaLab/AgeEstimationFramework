...
def VGG16(include_top=True, weights='vggface',
          ...
          pooling=None, classes=2622, lpf_size=1):
    ...
    x = LPFMaxPooling2D((2, 2), strides=(2, 2), name='pool1', lpf_size=lpf_size)(x)

    # Block 2
    x = Conv2D(128, (3, 3), activation='relu', padding='same', name='conv2_1')(x)
    x = Conv2D(128, (3, 3), activation='relu', padding='same', name='conv2_2')(x)
    x = LPFMaxPooling2D((2, 2), strides=(2, 2), name='pool2', lpf_size=lpf_size)(x)

    # Block 3
    x = Conv2D(256, (3, 3), activation='relu', padding='same', name='conv3_1')(x)
    x = Conv2D(256, (3, 3), activation='relu', padding='same', name='conv3_2')(x)
    x = Conv2D(256, (3, 3), activation='relu', padding='same', name='conv3_3')(x)
    x = LPFMaxPooling2D((2, 2), strides=(2, 2), name='pool3', lpf_size=lpf_size)(x)

    # Block 4
    x = Conv2D(512, (3, 3), activation='relu', padding='same', name='conv4_1')(x)
    x = Conv2D(512, (3, 3), activation='relu', padding='same', name='conv4_2')(x)
    x = Conv2D(512, (3, 3), activation='relu', padding='same', name='conv4_3')(x)
    x = LPFMaxPooling2D((2, 2), strides=(2, 2), name='pool4', lpf_size=lpf_size)(x)

    # Block 5
    x = Conv2D(512, (3, 3), activation='relu', padding='same', name='conv5_1')(x)
    x = Conv2D(512, (3, 3), activation='relu', padding='same', name='conv5_2')(x)
    x = Conv2D(512, (3, 3), activation='relu', padding='same', name='conv5_3')(x)
    x = LPFMaxPooling2D((2, 2), strides=(2, 2), name='pool5', lpf_size=lpf_size)(x)
    ...
    if include_top:
        ...
        features = x
        lastnm= '' if 8631==classes else '_%d'%classes
        x = Dense(classes, name='fc8'+lastnm)(x)
        x = Activation('softmax', name='fc8'+lastnm+'/softmax')(x)
    else:
        if pooling == 'avg':
...
def RESNET50(include_top=True, weights='vggface',
    ...
    if include_top:
        x = Flatten()(x)
        lastnm= '' if 8631==classes else '_%d'%classes
        x = Dense(classes, activation='softmax', name='classifier'+lastnm)(x)
    else:
        if pooling == 'avg':
            x = GlobalAveragePooling2D()(x)
        elif pooling == 'max':
