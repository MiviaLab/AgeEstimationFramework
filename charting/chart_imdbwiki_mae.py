import argparse
import os
from chart_utils import get_chart_path, get_data_on_imdbwiki, pretty_data_print, save_bar_chart
from xlsx_utils import get_xlsx_path, write_xlsx

parser = argparse.ArgumentParser(description='IMDB-WIKI Age chart')
