import argparse
import os
from chart_utils import get_chart_path, get_data_on_lfw_original_and_corrupted, pretty_data_print, save_bar_chart
from xlsx_utils import get_xlsx_path, write_xlsx
from collections import defaultdict

parser = argparse.ArgumentParser(description='LFW+ and LFW+C chart')
...
data = get_data_on_lfw_original_and_corrupted(input_files=input_files)
