import argparse
import os
from chart_utils import get_chart_path, get_data_on_lap, pretty_data_print, save_bar_chart
from xlsx_utils import get_xlsx_path, write_xlsx

parser = argparse.ArgumentParser(description='APPA-REAL Age chart')
...
data = get_data_on_lap(input_files=input_files)
